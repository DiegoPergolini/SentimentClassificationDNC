...
if FLAGS.num_classes == 5:
    ...
    from ReviewReaderTitle import balancedGetDataset
    from ReviewReaderTitle import getBalancedReviewsAndOverall
...
def execute(dictSize,num_training_iterations, report_interval):
  ...
  with tf.train.SingularMonitoredSession(
    ...
    for epochs in range(0,FLAGS.num_epochs):
        ...
        print(FLAGS.num_testing_iterations,FLAGS.batch_size)
        print((FLAGS.num_testing_iterations//FLAGS.batch_size))
        import numpy as np
        print(np.shape(allLines[1]))
        #################################################TRAINING########################################################
